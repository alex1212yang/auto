...
public class junit_add_camera {
	...
	public void Add_Camera() throws Exception {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.cssSelector("div[data-reactid='.0.1.1.0:$H8DDXGD2T936NK88111A.0.1']")));
		String element1 = driverChrome
				.findElement(By.cssSelector("div[data-reactid='.0.1.1.0:$H8DDXGD2T936NK88111A.0.1']")).getText();
		driverChrome.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		...
		// Device info-show message H8DDXGD2T936NK88111A
		driverChrome.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driverChrome.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String Device_info_show_message_UID = "H8DDXGD2T936NK88111A";
		wait.until(
